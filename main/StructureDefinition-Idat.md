...
## Resource Profile: IDAT 

| | |
| :--- | :--- |
| *Official URL*:https://ths-greifswald.de/fhir/StructureDefinition/dispatcher/Patient/Idat | *Version*:2025.2.0 |
| Active as of 2026-02-18 | *Computable Name*:Idat |
| **Copyright/Legal**: Copyright 2020-2026 Unabhängige Treuhandstelle der Universitätsmedizin Greifswald | |

 
Patienten-Profil zur Übermittlung von angeforderten IDAT an die fTTP für den Clearing-Prozess. 

**Usages:**

* Examples for this Profile: [Patient/Idat-example-1](Patient-Idat-example-1.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ths-greifswald.ttp-fhir-gw.dispatcher|current/StructureDefinition/StructureDefinition-Idat.json)
...
Other representations of profile: [CSV](StructureDefinition-Idat.csv), [Excel](StructureDefinition-Idat.xlsx), [Schematron](StructureDefinition-Idat.sch) 
