...
Um bestehende Anwenderprojekte und künftige Nutzer bei der Umsetzung FHIR-orientierter Infrastrukturen und Prozesse zu unterstützen, dient ein Treuhandstellen-FHIR-Gateway (kurz: TPP-FHIR Gateway) als Mittler zwischen FHIR-spezifischen Infrastrukturkomponenten und den bestehenden THS-Lösungsbausteinen.

 ![](assets/images/fhirgw-concept.png) 
...
Erfahrungsgemäß ist jedes Forschungsvorhaben individuell. So verhält es sich auch mit den Infrastrukturen. Das TTP-FHIR Gateway ist sowohl in Projekten, die "nur" gPAS, E-PIX oder gICS (bzw. eine Kombination der Lösungen) nutzen, anwendbar als auch in Projekten, die auf den Workflow-Manager (TTP-Dispatcher) setzen und somit nur indirekt mit den zugeordneten Lösungen kommunizieren.
...
**Die aktuellen Releases der Werkzeuge umfassen das TTP-FHIR Gateway standardmäßig.**
